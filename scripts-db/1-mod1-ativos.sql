...
-- ddl-end --
COMMENT ON COLUMN public.ativo.status IS E'(0) Indisponível (1) Disponível';
-- ddl-end --
...
-- ddl-end --
COMMENT ON COLUMN public.categoria.status IS E'(0) Indisponível (1) Disponível';
-- ddl-end --
