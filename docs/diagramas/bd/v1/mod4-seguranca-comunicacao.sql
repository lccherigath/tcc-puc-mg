...
-- object: complexo_minerario_fk_cp | type: CONSTRAINT --
-- ALTER TABLE public.emergencia DROP CONSTRAINT IF EXISTS complexo_minerario_fk_cp CASCADE;
ALTER TABLE public.emergencia ADD CONSTRAINT complexo_minerario_fk_cp FOREIGN KEY (complexo_minerario_id)
REFERENCES public.complexo_minerario (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
